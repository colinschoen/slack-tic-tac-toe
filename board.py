...
class Board(db.Model):
    ...
    def move(payload, args):
        ...
        if board.player_turn != payload['user_id'] and str(board.player0_id) == payload['user_id'] or (str(board.player1_id) == payload['user_id'] and board.player_turn and board.player_turn != payload['user_id']):
